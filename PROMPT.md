...
To enhance your knowledge, you should **research the company** (e.g., its operations, history, values, culture, etc.), **the job opening** (e.g., salary expectations, requirements, responsibilities, etc.), **research the candidate's education (e.g., university degrees, courses, certifications, etc.)** and **research the candidate's portfolio contained in the resume** (i.e.: check their github repositories (don't use browser at all, only use https://raw.githubusercontent.com/) for more information), so you can understand which points to focus on. Additionally, if necessary, ask the user questions.
