...
#show: rendercv.with(
  ...
  page-bottom-margin: 0.48cm,
  page-left-margin: 1.07cm,
  page-right-margin: 1.07cm,
  ...
  colors-links: rgb(67, 67, 67),
  colors-footer: rgb(128, 128, 128),
  colors-top-note: rgb(128, 128, 128),
  typography-line-spacing: 0.6em,
  typography-alignment: "justified",
  typography-date-and-location-column-alignment: right,
  typography-font-family-body: "Calibri",
  typography-font-family-name: "Calibri",
  typography-font-family-headline: "Calibri",
  typography-font-family-connections: "Calibri",
  typography-font-family-section-titles: "Calibri",
  typography-font-size-body: 11pt,
  typography-font-size-name: 11pt,
  typography-font-size-headline: 11pt,
  typography-font-size-connections: 11pt,
  typography-font-size-section-titles: 11pt,
  ...
  header-space-below-name: 11pt,
  header-space-below-headline: 11pt,
  header-space-below-connections: 22pt,
  header-connections-hyperlink: true,
  header-connections-show-icons: false,
  header-connections-display-urls-instead-of-usernames: true,
  header-connections-separator: " • ",
  header-connections-space-between-connections: 0cm,
  section-titles-type: "centered_without_line",
  section-titles-line-thickness: 0.5pt,
  section-titles-space-above: 23pt,
  section-titles-space-below: 11pt,
  sections-allow-page-break: true,
  sections-space-between-text-based-entries: 0cm,
  sections-space-between-regular-entries: 11pt,
...
Languages Python, C++, CUDA, Rust, Julia #h(1fr)

ML Frameworks PyTorch, JAX, TensorFlow, Triton, ONNX #h(1fr)

Infrastructure Kubernetes, Ray, distributed training, AWS, GCP #h(1fr)

Research Areas Neural architecture search, model compression, efficient inference, multi-agent RL #h(1fr)
